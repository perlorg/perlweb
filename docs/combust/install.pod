...
=head3 Create a user and get the goods
  ...
  su - combust
  rm .bashrc
  svn co http://svn.develooper.com/combust/branches/stable .
...
Combust is copyright 2003 Ask Bjørn Hansen and Develooper LLC.  See
