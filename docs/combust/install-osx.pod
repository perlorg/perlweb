...
Using subversion, checkout combust from:
  ...
  https://svn.perl.org/combust/trunk
...
https://svn.perl.org/perl.org/docs/ into a F<docs> subdirectory of
your combust installation.  If you don't like nested checkouts, or are
using a system such as svk that doesn't allow them, you can place it
elsewhere and symlink $CBROOT/docs -> wherever you put it.  (Note:
this is going to change in the future when the perl.org sites are
"isolated" from the main combust tree.)
