...
Send mail to <beginners-cgi-unsubscribe@perl.org>, and wait for a response.
...
This document will be emailed to the list once a month, and will be available
online in the archives, and at http://beginners.perl.org/
...
Complaints can be sent to <beginners-workers@perl.org>
...
above-all, useful to Perl/CGI beginners.

=head2 1.11 - When was this FAQ last updated?

Feb 04, 2004 

=head1 2 -  Questions about the 'beginners-cgi' list.
...
=item * Non Perl/CGI questions or issues
...
Basically, if it has to do with Perl/CGI , then it is allowed. 
If your question has nothing at all to do with Perl/CGI, it will likely be
ignored.
...
=item * CGI Programming with Perl, 2nd Ed., by Gunther Birznieks, et al. (O'Reilly)
...
=item * Please try to keep your signatures to 4 lines (or 5). Some people get quite annoyed when emails have long signatures.
