...
be treated hypothetically, not just variables stored in $0.  The distinction
of $0 variables is now syntactic.]
...
[Update: These days that's C<$0{'somerule'}[1]> or C<$«somerule»[1]>.]
...
[Update: These C<$0> variables now have names like C<@«foo»>, so skip
this step.]
...
[Update: Now C<$«foo»>, short for C<$0{'foo'}>.]
...
[Update: At the moment I think there's a .words method on strings.]
