...
There are other such variables too.]
...
See A12 for much more about classes and methods.]
...
[Update: instead of swiping C<< <> >> from iterators, we've used the
French quotes C<«»> for a C<qw//> replacement.]
...
[Update: Belay that order.  Angle brackets still do iteration on any
iterator, including filehandles.  There's also a corresponding C<< .<> >>
method.]
...
[Update: No, this confuses two different meanings of boolean.]
...
C<tied($foo).bar> to get at a property of the variable, or to call
