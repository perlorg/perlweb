...
in actual fact, smart match calls the C<.does> method, which is more
...
A regex is interpolated with C</<$expr>/>.]
...
as expected.  To return a closure you must be more explicit.]
