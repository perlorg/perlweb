...
[Update: Taht's C<trait_auxiliary:«is»> now.]
...
The curly form is required if the operator name contains French quotes.
Also, please note that the "hole" in circumfixes is now specified by
