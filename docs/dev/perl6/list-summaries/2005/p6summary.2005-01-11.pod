=head1 Perl 6 Summary for 2004-01-03 through 2004-01-11
...
Stéphane Payrard wanted to know if there is an easy way to alias arguments to a function.  Thus allowing a longer version for readability when calling the function and a short version inside the function.  Larry suggested C<< $s is named<subject> >>, which I like.  The thread then devolved into punning in French.
