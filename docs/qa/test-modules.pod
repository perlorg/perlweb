...
Allegedly easier to use than C<Test::Simple>. For simple cases.
...
Module to let you send F<make test> results to the CPAN testers.
The real workhorse is the F<cpantest> program.
...
Handy module for testing code that might throw a warning.
...
strings themselves are different.  Test-XML
