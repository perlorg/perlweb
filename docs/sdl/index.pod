...
B<07 February 2004>: 2.0.5 released!

Dave has returned, integrating several important and useful changes into
version 2.0.5.  While it winds its way to the CPAN, you can download it from
his backpan site:  L<http://backpan.cpan.org/authors/id/D/DG/DGOEHRIG/>.
Please report any strange behavior to the list.
...
SDL Perl snapshots (mostly stable, always up to date)

=item L<http://www.libsdl.org/>

The SDL Homepage

=item L<http://bloodgate.com/perl/sdl/>

Tels' Perl SDL pages

=item L<http://www.sdlperl.org/>

The old SDL Perl homepage (currently down)
