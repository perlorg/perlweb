...
B<10 January 2004>: all tests pass!

The develoment sources have seen much work lately, mostly concentrated on
improving the build process and on writing the tutorials as shown above.  For
the latest news (and snapshots), please visit the SDL Perl Snapshots page,
linked below.
